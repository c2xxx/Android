package com.chen.keepsort.xunfei;
...
import com.chen.keepsort.Logger;
...
//        String path = Environment.getExternalStorageDirectory() + "/012/tts" + System.currentTimeMillis() + ".pcm";
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
    ...
    protected void showLog(String msg) {
        Logger.d(msg);
        if (msg.indexOf("20001") != -1) {
//            VoicePlay.playNetError();
            Logger.d("网络错误");
        }
    }
