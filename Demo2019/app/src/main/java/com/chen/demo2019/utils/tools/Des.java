...
//    private static final String PASSWORD_CRYPT_KEY = "kEHrDooxWHCWtfeSxvDvgqZq";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String PASSWORD_CRYPT_KEY = "kEHrDooxWHCWtfeSxvDvgqZq";
        String str = Des.encrypt(md5Password, PASSWORD_CRYPT_KEY.getBytes());
        System.out.println("str: " + str);
        str = Des.decrypt(str, PASSWORD_CRYPT_KEY.getBytes());
        System.out.println("str: " + str);
    }
     ...
     */
    public final static String decrypt(String data, byte[] pwd) throws Exception {
        return new String(decrypt(hex2byte(data.getBytes()), pwd));
    }
     ...
     */
    public final static String encrypt(String data, byte[] pwd) throws Exception {
        byte[] xx = encrypt(data.getBytes(), pwd);
//        System.out.println("encrypt 1=" + new String(xx));
//        System.out.println("encrypt 2=" + JSON.toJSONString(xx));
        return byte2hex(xx);
    }
