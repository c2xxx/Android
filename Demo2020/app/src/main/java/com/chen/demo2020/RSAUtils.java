...
//        return Base64.encodeBase64URLSafeString(bytes);
    ...
    public static RSAPublicKey getPublicKey(String publicKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(decodeBase64(publicKey));
    ...
    public static String privateDecrypt(String data, RSAPrivateKey privateKey) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, decodeBase64(data), privateKey.getModulus().bitLength()), CHARSET);
        } catch (Exception e) {
    ...
    public static String publicDecrypt(String data, RSAPublicKey publicKey) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, Cipher.DECRYPT_MODE, decodeBase64(data), publicKey.getModulus().bitLength()), CHARSET);
        } catch (Exception e) {
            throw new RuntimeException("解密字符串[" + data + "]时遇到异常", e);
        }
    }
